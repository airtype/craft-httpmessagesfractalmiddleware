<?php
namespace HttpMessagesFractalMiddleware\Pagination;
...
class CraftPaginateVariableAdapter implements PaginatorInterface
{
    ...
    {
        $pagination_base_url = \Craft\craft()->config->get('paginationBaseUrl', 'httpMessagesFractalMiddleware');
        $page_trigger = \Craft\craft()->config->get('paginationParameter', 'httpMessagesFractalMiddleware');
